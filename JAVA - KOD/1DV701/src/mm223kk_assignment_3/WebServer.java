...
public class WebServer {
	...
	public static void main(String[] args){
			 try {				 
				 ...
				 System.err.println("Format should be: java WebServer [port] [serving_directory]");
	 ...
	 private static void initPort(String userPort) {
		// Try to read  the arguments and start the server.
	     try {
				...
				System.err.println("ERROR, with port number. Make sure that the port is free.");												// Throw error if port isn't within range.
				System.err.println("Format should be: java WebServer [port] [serving_directory]");						// Help to indicate needed formats.
	 			System.err.println("Example: java WebServer 5000 public");										
				System.exit(0);
			}
	 }
