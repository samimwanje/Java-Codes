...
public class Problem_3_4_main {

	public static void main(String[] args) {
		Problem_3_4_Heapsort Heapsort = new Problem_3_4_Heapsort();
		/* Made to wroking sorting algorthims. 
		int numbers1[] = Heapsort.sort(new int[]{1,4,8,2,5,9,3,7,6});	// Set from lecture.
		int numbers2[] = Heapsort.sort(new int[]{1, 17, 12, 20, 10, 15, 16, 5, 13, 7});	
		int numbers3[] = Heapsort.sort(new int[]{9, 13, 17, 6, 7, 3, 15, 10, 16, 11});
		int numbers4[] = Heapsort.sort(new int[]{97, 33, 90, 52, 28, 17, 44, 46, 67, 32});
		 */
