...
public class Problem_2_LinkedList<T> {
	...
	public void reverse() {
	 ...
	 // existing class fields and methods

    public Iterator<T> iterator() {
        return new Problem_2_LinkedListIterator();
    }

    private class Problem_2_LinkedListIterator implements Iterator<T> {
        private LinkedNode<T> current = first;
