...
public class Errors {
	...
	Errors(Socket socket, File root) {
	 ...
	 /**
	  * This method is called if an internal error occurs.
	  * It return the error code 500 to the user,
	  * There is the deepest level of error handling.
	  */
	 public void internalError(){
		  System.out.println("500 Internal Server Error.");		// Print that an internal error has occured.
		  byte[] errorPage = null;		
		  try {	// Try the error solution based on my own server set up.
